...
const GifPicker = ({ onSelect, onClose, anchorRef }) => {
  ...
  // Calcular posición del panel relativa al botón GIF
  useEffect(() => {
  ...
  const panel = (
    <div
      ...
      className="w-72 bg-panel border border-white/15 rounded-2xl shadow-2xl overflow-hidden"
    >
      {/* Búsqueda */}
